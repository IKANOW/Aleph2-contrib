...
public class MongoDbCrudService<O, K> implements ICrudService<O> {
	...
	//TODO (ALEPH-22) Handle 1) JsonObject cursor... 2) Insert JsonObject	
	...
	@Override
	@NonNull
	public Future<Boolean> updateObjectBySpec(@NonNull QueryComponent<O> unique_spec, Optional<O> set, Optional<QueryComponent<O>> add, Optional<QueryComponent<O>> remove)
	{
		// TODO Auto-generated method stub
		return null;
	}
	...
	public Future<Boolean> updateAndReturnObjectBySpec(
			...
			Optional<QueryComponent<O>> add, Optional<QueryComponent<O>> remove,
			Optional<Boolean> before_updated) {
		// TODO Auto-generated method stub
		return null;
	}
