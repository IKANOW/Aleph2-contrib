...
public class MockV2SecurityService extends SecurityService implements ISecurityService {
	...
	@Inject
	public MockV2SecurityService(IServiceContext serviceContext, SecurityManager securityManager) {
		super(serviceContext, securityManager);		
	}
	
	public static List<Module> getExtraDependencyModules() {
		return Arrays.asList((Module)new IkanowV2SecurityModule(){
				@Override
