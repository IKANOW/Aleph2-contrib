 ...
 * @author Alex
 */
public class TestBeFileInputReader {
	...
	public void check_batchRecordIsSerializable() throws IOException {
		...
		{
			final IBatchRecord test_case = new BeFileInputReader.BatchRecord(test_json, null);
		...
		{
			final IBatchRecord test_case = new BeFileInputReader.BatchRecord(test_json, test_out);
