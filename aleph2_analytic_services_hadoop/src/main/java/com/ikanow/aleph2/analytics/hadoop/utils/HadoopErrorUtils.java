...
public class HadoopErrorUtils {
	...
	final public static String CURR_INPUT_RESTRICTIONS = "Currently only supported inputs are: batch, storage_service, search_index_service, not: {0} (bucket:job = {1}:{2})";
