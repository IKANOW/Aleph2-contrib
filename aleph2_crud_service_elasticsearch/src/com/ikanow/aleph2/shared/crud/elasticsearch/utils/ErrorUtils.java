...
public class ErrorUtils extends com.ikanow.aleph2.data_model.utils.ErrorUtils {
	...
	public static final String EXISTS_ON_TYPES = "It is not possible to make 'exists' queries on _types, since each data object has excactly one _type value";
	...
	public static final String ALL_OF_ON_TYPES = "It is not possible to make 'all_of' queries on _types, since each data object can only have one _type value";
	...
	public static final String RANGES_ON_TYPES = "It is not possible to make range queries on _types";
