...
public class TestMongoDbManagementDbService {
	...
	public void test_getPerBucketState() throws InterruptedException, ExecutionException {
		...
		String harvest_name;
		{
			...
			assertEquals("aleph2_harvest_state_1.test_ext_4354_t_bb8a6a382d7b", dbc1.getFullName());
			assertEquals("aleph2_harvest_state_1.test_ext_4354_t_bb8a6a382d7b", dbc2.getFullName());
		...
		String enrich_name;
		{
			...
			assertEquals("aleph2_enrich_state_1.test_ext_4354_t_bb8a6a382d7b", dbc1.getFullName());
			assertEquals("aleph2_enrich_state_1.test_ext_4354_t_bb8a6a382d7b", dbc2.getFullName());
		...
		
		{
			...
			assertEquals("aleph2_analytics_state_1.test_ext_4354_t_bb8a6a382d7b", dbc1.getFullName());
			assertEquals("aleph2_analytics_state_1.test_ext_4354_t_bb8a6a382d7b", dbc2.getFullName());
	...
	public void test_getPerLibraryState() throws InterruptedException, ExecutionException {
		...
		final DBCollection dbc1 = test.getUnderlyingPlatformDriver(DBCollection.class, Optional.empty()).get();
		{
			...
			assertEquals("aleph2_library_state_1.test_ext_4354_t_bb8a6a382d7b", dbc1.getFullName());
			assertEquals("aleph2_library_state_1.test_ext_4354_t_bb8a6a382d7b", dbc2.getFullName());
