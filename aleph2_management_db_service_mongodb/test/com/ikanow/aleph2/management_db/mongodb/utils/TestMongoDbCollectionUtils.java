...
public class TestMongoDbCollectionUtils {
	...
	public void test_baseIndexName() {
		...
		assertEquals("test_ext_4354___bb8a6a382d7b", BucketUtils.getUniqueSignature(path2, Optional.empty()));
		...
		assertEquals("test_ext_more_componen_xx___ec9cbb79741c", BucketUtils.getUniqueSignature(path3, Optional.of("XX__________")));
	}
	...
	public void test_findDatabase() {
		...
		final String coll_name2 = "test_ext_4354___bb8a6a382d7b";
		...
		// (Now fill some in)
		mock_crud_service_factory.getMongoDb("test_findDatabase_1").getCollection("test_ext_more_componen_xx___ec9cbb79741c").save(new BasicDBObject());
		...
		mock_crud_service_factory.getMongoDb("test_findDatabase_5").getCollection("test_ext_4354___bb8a6a382d7b").save(new BasicDBObject());
