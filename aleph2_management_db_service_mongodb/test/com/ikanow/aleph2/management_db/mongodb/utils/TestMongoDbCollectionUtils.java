...
public class TestMongoDbCollectionUtils {
	...
	@Test
	public void test_baseIndexName() {
		...
		assertEquals("test_ext_c1651d4c69ed", BucketUtils.getUniqueSignature(path1, Optional.empty()));
		assertEquals("test_ext_test_12_c1651d4c69ed", BucketUtils.getUniqueSignature(path1, Optional.of("test+;12345")));
		assertEquals("test_ext_4354__bb8a6a382d7b", BucketUtils.getUniqueSignature(path2, Optional.empty()));
		assertEquals("test_ext_4354_t_bb8a6a382d7b", BucketUtils.getUniqueSignature(path2, Optional.of("t")));
		assertEquals("test_ext_more_componen_ec9cbb79741c", BucketUtils.getUniqueSignature(path3, Optional.empty()));
	...
	public void test_findDatabase() {
		...
		final String coll_name1 = "test_ext_4354_t_bb8a6a382d7b";
		...
		mock_crud_service_factory.getMongoDb("test_findDatabase_3").getCollection("test_ext_4354_t_bb8a6a382d7b").save(new BasicDBObject());
